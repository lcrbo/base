<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {!! $errors->first('two_factor_secret', '<div class="invalid-feedback">:message</p>') !!}
        </div>
        <div class="form-group">
            ...
            {!! $errors->first('two_factor_recovery_codes', '<div class="invalid-feedback">:message</p>') !!}
        </div>
        <div class="form-group">
            ...
            {!! $errors->first('current_team_id', '<div class="invalid-feedback">:message</p>') !!}
        </div>
        <div class="form-group">
            ...
            {!! $errors->first('profile_photo_path', '<div class="invalid-feedback">:message</p>') !!}
        </div>
